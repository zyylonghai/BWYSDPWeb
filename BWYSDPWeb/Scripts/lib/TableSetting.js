...
LibTable.prototype = {
    ...
    initialTable: function () {
        ...
        $('#' + this.$table.ElemtableID).bootstrapTable({
            ...
            onExpandRow: function (index, row, $detail) {
                ...
                var toolhtml = "<div id='" + toolid + "' class='btn-group'>" +
                    ...
                    "<button type='button' class='btn btn-default' onclick='return TableBtnEdit(this,\""+tbobj.SubTable.$table.ElemtableID +"\")' data-toggle=\"modal\"  data-target='#sdp_tbmdl_GridGroup_" + tbobj.SubTable.$subtableParam.gridid + "'  data-gridid='" + tbobj.SubTable.$table.ElemtableID + "' data-deftbnm='" + tbobj.SubTable.$subtableParam.deftbnm + "' data-tablenm='" + tbobj.SubTable.$subtableParam.tablenm + "' data-controlnm='" + tbobj.SubTable.$subtableParam.controlnm + "'  data-cmd='Edit'><i class='glyphicon glyphicon-pencil'></i></button>" +
                    "<button type='button' class='btn btn-default' onclick='return TableBtnDelete(this,\""+tbobj.SubTable.$table.ElemtableID +"\",\""+ tbobj.SubTable.$subtableParam.deftbnm +"\",\""+ tbobj.SubTable.$subtableParam.tablenm +"\",\""+ ((tbobj.SubTable.$subtableParam.controlnm == '' || tbobj.SubTable.$subtableParam.controlnm == null || tbobj.SubTable.$subtableParam.controlnm == undefined) ? "DataBase" : tbobj.SubTable.$subtableParam.controlnm ) + "\")'><i class='glyphicon glyphicon-trash'></i></button>" +
                    "</div>";
        ...
        if (this.$table.height > 0) {
            $('#' + this.$table.ElemtableID).bootstrapTable('resetView', { height: this.$table.height });
        }
